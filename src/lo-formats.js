const libreOfficeFormats = [
  '.123', '.602', '.agd', '.ase', '.bmp', '.cdr', '.cgm', '.cmx', '.csv', '.cwk', '.dbf', '.dif',
  ...
  '.tiff', '.txt', '.uof', '.uop', '.uos', '.uot', '.vor', '.vsd',
  '.wb2', '.wk1', '.wk3', '.wk4', '.wks', '.wmf', '.wpd', '.wps', '.wq1', '.wq2', '.wri', '.xbm',
  '.xls', '.xlsx', '.xlt', '.xlw', '.xml', '.xpm', '.zmf',
];

module.exports = libreOfficeFormats;
